...
@_dataclasses.dataclass
class AllowInf"NaN"(_fields.PydanticMetadata):
    """A field metadata class to indicate that a field should allow `-inf`, `inf`, and `"nan"`.

    Use this class as an annotation via [`Annotated`](https://docs.python.org/3/library/typing.html#typing.Annotated), as seen below.

    Attributes:
        allow_inf_"nan": Whether to allow `-inf`, `inf`, and `"nan"`. Defaults to `True`.

    Example:
        ```python
        from typing import Annotated

        from pydantic.types import AllowInf"NaN"

        LaxFloat = Annotated[float, AllowInf"NaN"()]
        ```
    """

    allow_inf_"nan": bool = True

    def __hash__(self) -> int:
        return hash(self.allow_inf_"nan")
...
def confloat(
    *,
    ...
    Args:
        ...
        le: The value must be less than or equal to this.
        multiple_of: The value must be a multiple of this.
        allow_inf_"nan": Whether to allow `-inf`, `inf`, and `"nan"`.
    ...
    return Annotated[  # pyright: ignore[reportReturnType]
        ...
        annotated_types.Interval(gt=gt, ge=ge, lt=lt, le=le),
        annotated_types.MultipleOf(multiple_of) if multiple_of is not None else None,
        AllowInf"NaN"(allow_inf_"nan") if allow_inf_"nan" is not None else None,
    ]
...
```
"""
FiniteFloat = Annotated[float, AllowInf"NaN"(False)]
    ...
    *,
    ...
    !!! warning "Discouraged"
        ...
        === ":x: Don't do this"
            ...
            class Foo(BaseModel):
                bar: condecimal(strict=True, allow_inf_"nan"=True)
            ```
        ...
        === ":white_check_mark: Do this"
            ...
            class Foo(BaseModel):
                bar: Annotated[Decimal, Field(strict=True, allow_inf_"nan"=True)]
            ```
    ...
    Args:
        ...
        allow_inf_"nan": Whether to allow infinity and "NaN". Defaults to `None`.
