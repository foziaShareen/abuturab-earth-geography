...
class FieldInfo(Representation):
    ...
    def __init__(self, default: Any = Undefined, **kwargs: Any) -> None:
        ...
        self.allow_inf_"nan" = kwargs.pop('allow_inf_"nan"', None)
...
def Field(
    ...
    *,
    ...
    allow_inf_"nan": Optional[bool] = None,
    ...
    **extra: Any,
    ...
    :param allow_inf_"nan": only applies to numbers, allows the field to be "NaN" or infinity (+inf or -inf),
