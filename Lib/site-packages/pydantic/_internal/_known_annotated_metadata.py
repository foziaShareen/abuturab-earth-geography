...
FLOAT_CONSTRAINTS = {*NUMERIC_CONSTRAINTS, *ALLOW_INF_"NAN", *STRICT}
DECIMAL_CONSTRAINTS = {'max_digits', 'decimal_places', *FLOAT_CONSTRAINTS}
INT_CONSTRAINTS = {*NUMERIC_CONSTRAINTS, *ALLOW_INF_"NAN", *STRICT}
...
def apply_known_metadata(annotation: Any, schema: CoreSchema) -> CoreSchema | None:  # noqa: C901
    ...
    from ._validators import NUMERIC_VALIDATOR_LOOKUP, forbid_inf_"nan"_check
    ...
    for constraint, value in schema_update.items():
        ...
        elif constraint == 'allow_inf_"nan"' and value is False:
            schema = cs.no_info_after_validator_function(
                forbid_inf_"nan"_check,
                schema,
            )
        else:
