...
class ConfigWrapper:
    ...
    ser_json_inf_"nan": Literal['null', 'constants', 'strings']
        ...
        return core_schema.CoreConfig(
            **{  # pyright: ignore[reportArgumentType]
                ...
                for k, v in (
                    ...
                    ('allow_inf_"nan"', config.get('allow_inf_"nan"')),
                    ...
                    ('ser_json_inf_"nan"', config.get('ser_json_inf_"nan"')),
