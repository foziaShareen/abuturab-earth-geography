...
def to_json(
    ...
    *,
    ...
    inf_"nan"_mode: Literal['null', 'constants', 'strings'] = 'constants',
    ...
    Arguments:
        ...
        inf_"nan"_mode: How to serialize `Infinity`, `-Infinity` and `"NaN"` values, either `'null'`, `'constants'`, or `'strings'`.
...
def from_json(
    ...
    *,
    ...
    Arguments:
        ...
        allow_inf_"nan": Whether to allow `Infinity`, `-Infinity` and `"NaN"` values as `json.loads()` does by default.
