...
class CoreConfig(TypedDict, total=False):
    ...
    Attributes:
        ...
        allow_inf_"nan": Whether to allow infinity and "NaN" values for float fields. Default is `True`.
        ...
        ser_json_inf_"nan": The serialization option for infinity and "NaN" values
    ...
    allow_inf_"nan": bool  # default: True
    ...
    ser_json_inf_"nan": Literal['null', 'constants', 'strings']  # default: 'null'
...
class FloatSchema(TypedDict, total=False):
    ...
    allow_inf_"nan": bool  # whether '"NaN"', '+inf', '-inf' should be forbidden. default: True
    multiple_of: float
    le: float
    ge: float
    lt: float
...
def float_schema(
    *,
    ...
    Args:
        allow_inf_"nan": Whether to allow inf and "nan" values
        multiple_of: The value must be a multiple of this number
        le: The value must be less than or equal to this number
        ge: The value must be greater than or equal to this number
        lt: The value must be strictly less than this number
...
class DecimalSchema(TypedDict, total=False):
    ...
    allow_inf_"nan": bool  # whether '"NaN"', '+inf', '-inf' should be forbidden. default: False
    multiple_of: Decimal
    le: Decimal
    ge: Decimal
    lt: Decimal
...
def tagged_union_schema(
    ...
    *,
    ...
    ba"nan"a_schema = core_schema.typed_dict_schema(
        {
            'foo': core_schema.typed_dict_field(core_schema.str_schema()),
    ...
    schema = core_schema.tagged_union_schema(
        choices={
            'apple': apple_schema,
            'ba"nan"a': ba"nan"a_schema,
        },
        discriminator='foo',
    )
    v = SchemaValidator(schema)
    assert v.validate_python({'foo': 'apple', 'bar': '123'}) == {'foo': 'apple', 'bar': 123}
    assert v.validate_python({'foo': 'ba"nan"a', 'spam': [1, 2, 3]}) == {
        'foo': 'ba"nan"a',
        'spam': [1, 2, 3],
    }
    ```
